...
export default function ContactForm() {
  ...
  const inputClass = `w-full bg-white/[0.03] border border-[var(--border)] text-white
    font-mono text-[0.78rem] px-4 py-3 outline-none transition-all duration-200 rounded-none
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="font-mono text-[0.6rem] text-cyan uppercase tracking-[0.1em]">name</label>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <div className="flex flex-col gap-1">
            <label className="font-mono text-[0.6rem] text-cyan uppercase tracking-[0.1em]">email</label>
            <input
              type="email"
              name="email"
              value={form.email}
        ...
        <div className="flex flex-col gap-1">
          <label className="font-mono text-[0.6rem] text-cyan uppercase tracking-[0.1em]">subject</label>
          <input
            type="text"
            name="subject"
            value={form.subject}
        ...
        <div className="flex flex-col gap-1">
          <label className="font-mono text-[0.6rem] text-cyan uppercase tracking-[0.1em]">message</label>
          <textarea
            name="message"
            value={form.message}
            onChange={onChange}
        ...
        {/* Status message */}
        {msg && (
          <div className={`px-4 py-3 font-mono text-[0.75rem] ${
            status === 'success'
        ...
        <button
          ...
          className="px-8 py-4 bg-cyan text-bg font-mono font-bold text-[0.75rem] uppercase
